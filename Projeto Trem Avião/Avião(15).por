programa {	
  ...
  inteiro opcao, fusoOrigem = 0, fusoDestino = 0, quantidadeDePontos = 0, horaDecolagem = 0, minutoDecolagem = 0, horarioChegadaUTC = 0, horarioChegadaLocal = 0, tempoTotalVoo = 0, jaPassouPor = 0, temporealfinal =0
  cadeia aeroportoOrigem = " ", aeroportoDestino = " "
  real velocidadeCruzeiro, distanciaTotal
  cadeia nomePontos[100], rmPontos[100]
  real distanciaPontos[100]
  ...
  */
  ...
  funcao formatacaoTempoVooTrecho(cadeia trecho, cadeia nomeDoPonto, cadeia rm, cadeia rm2, cadeia dt, real dt2, cadeia eto, real tv){
    ...
    se(resultado <= 59){
      ...
      se(resultado - resultado2 >= 0.0001 ou resultado - resultado2 <= 0.49){
        ...
        //Retorna o texto pela função com o texto o número do trecho, separação por 2 pontos, o tempo, mais minutos
      	escreva(trecho, nomeDoPonto, rm, rm2, dt, dt2, eto, resultado2, " minutos\n")   
      } senao{

      //Exibe o tempo total do voo em minutos
      escreva(trecho, nomeDoPonto, rm, rm2, dt, dt2, eto, tv, " minutos\n")
      }
    } senao{
      ...
      escreva(trecho, nomeDoPonto, rm, rm2, dt, dt2, eto, formatarHoraMinutos(tv), " horas\n")
    }
  }
  ...
  funcao exibirDados(){
    ...
    escreva("\n\nInformações de cada trecho: \n")

    //"Para" para exibir todas as distâncias dentro do vetor
    para(inteiro i = 0; i < quantidadeDePontos; i++) {
      formatacaoTempoVooTrecho("Trecho: ", nomePontos[i], " | RM:  ", rmPontos[i], " | Distância: ", distanciaPontos[i], " | ETO: ", calcularETO(distanciaPontos[i], velocidadeCruzeiro))
    }
