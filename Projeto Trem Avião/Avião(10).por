programa {	
  ...
  funcao entradaDados() {
    ...
    validacaoDeHorario("Insira a hora de decolagem (em UTC): ", horaDecolagem)

    validacaoDeMinutos("Insira os minutos de decolagem (em UTC): ", minutoDecolagem)
    ...
    se(quantidadeDePontos <= 0) {
      ...
      para(inteiro i = 0; i < quantidadeDePontos; i++){
        ...
        validacaoPontoDeReferencia("Distância até o próximo ponto: ", distanciaPontos[i])
  ...
  funcao validacaoDeCodigoAeroporto(cadeia texto, cadeia codigo){
    inteiro tamanho
    caracter digito
  ...
  funcao inteiro validacaoFusoHorario(cadeia texto, inteiro fuso){
    inteiro permissao = 0
  ...
  funcao inteiro validacaoDeHorario(cadeia texto, inteiro hora){
    inteiro permissao = 0
  ...
  funcao inteiro validacaoDeMinutos(cadeia texto, inteiro minutos){
    inteiro permissao = 0
  ...
  funcao real validacaoPontoDeReferencia(cadeia texto, real distancia){
    inteiro permissao = 0
