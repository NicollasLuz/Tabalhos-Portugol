programa {	
  ...
  cadeia aeroportoOrigem = " ", aeroportoDestino = " ", gmtOrigem, gmtDestino, impressarVelociade
  ...
  */
  ...
  funcao formatacaoTempoVooTrecho(inteiro trecho, cadeia ponto, cadeia nomeDoPonto, cadeia rm, cadeia rm2, cadeia dt, cadeia dt2, cadeia eto, real tv, cadeia traco){
    ...
    se(resultado <= 59){
      ...
      escreva(trecho, ponto, nomeDoPonto, rm, rm2, dt, dt2, eto, formatarHoraMinutos(tv), " horas", traco)
    }
  }
