programa {	
  ...
  inteiro opcao, fusoOrigem = 0, fusoDestino = 0, quantidadeDePontos = 0, horaDecolagem = 0, horarioChegadaUTC = 0, horarioChegadaLocal = 0, tempoTotalVoo = 0, jaPassouPor = 0, temporealfinal = 0, horarioDecolagemMinutos
  cadeia aeroportoOrigem = " ", aeroportoDestino = " "
  real velocidadeCruzeiro, distanciaTotal, minutoDecolagem = 0
  ...
  funcao entradaDados() {
    ...
    se(quantidadeDePontos <= 0) {
      ...
      escreva("Insira os pontos de referência (nome, rumo magnético e distância até o próximo ponto): \n")
  ...
  */
    funcao  validacaoDeHorario(cadeia texto, inteiro hora, real minutos){
  ...
  funcao inteiro paraMinutos(inteiro horas, real minutos) {
  ...
  funcao exibirDados(){
    escreva("-----------------------------------------------\n")
    escreva("|                 |   Origem   |    Destino   |\n")
    escreva("| Indicativo:     |    ", aeroportoOrigem, "    |     ", aeroportoDestino, "     | \n" )
    escreva("| Fuso Horário:   |   GMT", fusoOrigem, "    |    GMT", fusoDestino, "     |\n")
    escreva("| Distância Voo:  |             ", formataNumero(distanciaTotal, 2), "            |\n")
    escreva("| Velocidade:     |             ", formataNumero(velocidadeCruzeiro, 2), "            |\n\n")



    escreva("___________________________________________________________________________________ \n") 
    escreva("         REFERÊNCIA         |    RM     |   DISTÂNCIA   |           ETO           | \n") 
    escreva("----------------------------------------------------------------------------------- \n")  
    ...
    escreva("\nHorários: ")
    escreva("\nEm UTC: Decolagem: ", horaDecolagem, ":", formataNumero(minutoDecolagem, 2), " | Pouso: ", formatarHoraMinutos(horarioChegadaUTC))
    escreva("\nEm HLO: Decolagem: ", horaDecolagem + fusoDestino, ":", formataNumero(minutoDecolagem, 2), " | Pouso: ", formatarHoraMinutos(horarioChegadaLocal))
