programa {	
  ...
  */
    ...
    se(resultado <= 59){
      ...
      se(resultado - resultado2 >= 0.0001 ou resultado - resultado2 <= 0.49){
        ...
        //Retorna o texto pela função com o texto o número do trecho, separação por 2 pontos, o tempo, mais minutos
      	escreva(trecho, ponto, nomeDoPonto, rm, rm2, dt, dt2, eto, formataNumero(resultado2, 2), " minutos", traco)   
      } senao{
      temporealfinal += resultado2
      //Exibe o tempo total do voo em minutos
      escreva(trecho, ponto, nomeDoPonto, rm, rm2, dt, dt2, eto, formataNumero(tv, 2), " minutos", traco)
      }
    } senao{
      temporealfinal += resultado2
  ...
  funcao exibirDados(){
    ...
    escreva("-----------------------------------------------\n")
    escreva("| Distância Voo:  |             ", impressarDistaniaVoo)
    escreva("-----------------------------------------------\n")
