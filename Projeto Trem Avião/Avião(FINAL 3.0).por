  ...
  */
  ...
  funcao exibirDados(){
    ...
    para(inteiro u = 0; u != quantidadeDePontos; u++) {
      escreva(formatacaoTempoVooTrecho(u + 1, ". " , formataTexto(nomePontos[u]), " | ", formataNumero(rmPontos[u], 3), " |  ", formataNumero(distanciaPontos[u], 2), " |  ", calcularETO(distanciaPontos[u], velocidadeCruzeiro)))
    }
